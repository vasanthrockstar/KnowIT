...
class MyReactionsPage extends StatelessWidget {
  const MyReactionsPage({Key key, this.choice, @required this.database})
      : super(key: key);
...
class F_MyReactionsPage extends StatefulWidget {
  F_MyReactionsPage({@required this.database});
  final Database database;

  @override
  _F_MyReactionsPageState createState() => _F_MyReactionsPageState();
}

class _F_MyReactionsPageState extends State<F_MyReactionsPage> {
  @override
  Widget build(BuildContext context) {
  ...
  Widget showFeed() {
    return StreamBuilder<List<PostDetails>>(
            stream: widget.database.readSubQueryPosts('reacted_ids',USER_ID),
